...
const Footer = () => {
  return (
    <footer className=" bg-gray-900 text-white py-6 flex flex-col justify-center items-center">
      <div className="w-full max-w-7xl px-6 text-center">
        ...
        <nav className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-4">
          ...
          <a href="#" className="hover:text-fuchsia-400 transition-colors">Jobs</a>
