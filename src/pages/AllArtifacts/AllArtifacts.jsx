...
const AllArtifacts = () => {
  ...
  return (
    <div className="container mx-auto  p-6">
      <h2 className="text-3xl font-bold text-center mb-6">All Artifacts : {artifacts.length}</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredArtifacts.length > 0 ? (
          ...
          <p className="text-center col-span-3 text-gray-500">No artifacts found matching your search.</p>
        )}
      </div>
    </div>
  );
